...
import { IMessageDocuemnt } from '../interfaces/chat.interace';
...
export const MessageModel: Model<IMessageDocuemnt> = model<IMessageDocuemnt>('Message', messageSchema, 'Message');
