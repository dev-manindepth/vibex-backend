...
export class Get {
  ...
  public async singleReactionByUsername(req: Request, res: Response): Promise<void> {
    ...
    const cachedReaction: [IReactionDocument, number] | [] = await reactionCache.getSingleReactionByUsernameForCache(postId, username);
  ...
  public async reationsByUsername(req: Request, res: Response): Promise<void> {
